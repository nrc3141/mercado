...
public class ProdutoDAO {
    ...
    public List<Produto> procurarOutrosFabricanteMesmoNome(Integer id, String nome) throws Exception {
	EntityManager em = HibernateUtil.getEntityManager();
	try {
	    Query query = em.createQuery("FROM Produto WHERE nome = :nome AND id != :id");
